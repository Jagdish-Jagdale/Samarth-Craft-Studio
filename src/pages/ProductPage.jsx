...
export default function ProductPage() {
  ...
  console.log("ProductPage Debug:", {
    ...
    availableProductIds: productsList.map((p) => ({
      id: p.id,
      idType: typeof p.id,
      name: p.name,
    })),
  ...
  const productImages =
    matchedProduct.colorVariants && matchedProduct.colorVariants.length > 0
  ...
  const referringReseller = referralCode
    ? resellers.find((r) => {
        ...
        return (
          (r.id && r.id.toString().trim() === cleanRef) ||
  ...
  const basePrice =
    typeof matchedProduct.price === "number"
      ...
      : parseFloat(
          String(matchedProduct.price || "0").replace(/[^\d.]/g, ""),
        ) || 0;
  const commissionRate = referringReseller
    ? parseFloat(referringReseller.commissionValue || 10)
    : 0;
  ...
  const finalPrice = referringReseller
    ? discountedPrice + commissionAmount
    : discountedPrice;
    ...
    const sizeInfo =
      matchedProduct.category === "Kolhapuri Chappal"
        ...
        : matchedProduct.category === "Jewellery" &&
            matchedProduct.name.toLowerCase().includes("ring")
          ? selectedRingSize
          : null;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="block lg:hidden w-full relative mb-4">
              ...
              <div className="flex justify-between items-center mb-3">
                <span className="text-[10px] text-dark/40 tracking-widest font-semibold uppercase">
                  PREVIEW
                </span>
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-3">
              ...
              {Number(matchedProduct.discount) > 0 && (
                <span className="bg-green-50 text-green-700 text-xs px-2 py-1 font-medium border border-green-200 rounded">
                  {Number(matchedProduct.discount)}% OFF
                </span>
              )}
              {referringReseller && (
            ...
            {matchedProduct.colorVariants &&
              matchedProduct.colorVariants.length > 1 && (
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-xs font-medium tracking-widest text-dark/60">
                      SELECT COLOR
                    </p>
                  </div>
            ...
            {matchedProduct.category === "Kolhapuri Chappal" && (
              <div className="mb-6">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  Object.keys(matchedProduct.sizes).length > 0
                    ? Object.keys(matchedProduct.sizes).map(Number)
                    : defaultSizes
                  ).map((s) => {
                    const isSizeInStock = matchedProduct.sizes
                      ? Number(matchedProduct.sizes[s] || 0) > 0
                      : true;
                    return (
                      <motion.button
                        key={s}
              ...
              matchedProduct.name.toLowerCase().includes("ring") && (
                <div className="mb-6">
                  ...
                  <div className="mt-2 text-xs text-dark/50">
                    Selected: Size {selectedRingSize} (US{" "}
                    {
                      ringSizeChart.find((s) => s.indian === selectedRingSize)
                        ?.us
                    }
                    , UK{" "}
                    {
                    ...
                    {expandedSection === section.key && (
                      ...
                      >
                        <div className="pb-4 text-sm text-dark/60 leading-relaxed">
                            ...
                            <>
                              <p className="mb-3">
                                {matchedProduct.description ||
                                  "Constructed from premium materials that soften and shine with age. Every detail is hand-executed by a third-generation master artisan from the Kolhapur cluster."}
                              </p>
                              {matchedProduct.category ===
                                "Kolhapuri Chappal" && (
                                <ul className="space-y-1.5">
                                  {[
                                    "Hand-braided silk thread accents",
                                    "Double-layered cushioned leather footbed",
                                  ].map((b) => (
                                    <li
                                      key={b}
                              ...
                              {matchedProduct.category === "Jewellery" && (
                                <div className="mt-4 border-t border-dark/5 pt-3">
                                  <p className="text-[10px] font-bold text-dark/70 tracking-wider mb-2 uppercase font-sans">
                                    Specifications
                                  </p>
                                    ...
                                    <tbody>
                                      {matchedProduct.weight && (
                                        <tr className="border-b border-dark/5">
                                          <td className="py-2 font-medium w-1/3">
                                            Net Weight
                                          </td>
                                          <td className="py-2 text-dark font-semibold">
                                            {matchedProduct.weight}
                                          </td>
                                        </tr>
                                      )}
                          ...
                          {section.key === "care" && (
                            <p>
                              Clean with a soft dry cloth. Avoid exposure to
                              water. Store in the provided dust bag away from
                              direct sunlight.
                            </p>
                          )}
                          {section.key === "shipping" && (
                            <p>
                              Free shipping across India. Delivered within 5-7
                              business days. 14-day returns accepted for unworn
                              items.
                            </p>
                          )}
                        </div>
            ...
            <div className="flex items-center gap-3 mb-6">
              <div>
                <p className="text-xs text-dark/40 tracking-widest mb-1">
                  TOTAL PRICE
                </p>
                ...
                {referringReseller && (
                  <p className="text-xs text-emerald-600 mt-1">
                    Base: ₹{discountedPrice.toLocaleString()} + Commission: ₹
            ...
            <div className="flex gap-3 mb-6">
              ...
              >
                {isWishlisted ? (
                  ...
                  <svg
                    className="w-5 h-5 text-dark/70 hover:text-red-500"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth={1.5}
                    viewBox="0 0 24 24"
            ...
            <div className="mb-6 bg-[#faf8f5] border border-dark/5 p-5 rounded-xl space-y-3">
              <div className="flex flex-col gap-2.5 text-xs text-dark/80 font-semibold font-sans">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span>
                    Easy Exchange{" "}
                    <span className="text-dark/50 text-[10px] font-normal font-serif">
                      (जर देणार असशील)
                    </span>
                  </span>
                </div>
            ...
            <div className="flex items-center justify-between text-center">
              {[
                ...
                >
                  ...
                  <span className="text-xs text-dark/40 tracking-wide">
                    {badge.label}
                  </span>
                </div>
              ))}
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-gold-600 tracking-widest">
                      {r.tag}
                    </p>
                  </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            >
              <div className="text-center relative">
                ...
                <h3 className="font-serif text-xl font-bold mt-2 text-dark">
                  Write a Customer Review
                </h3>
                <p className="text-[10px] text-dark/45 uppercase tracking-widest font-bold">
                  Featured in our customer stories
                </p>
              </div>
              ...
              {reviewSubmitted ? (
                ...
                >
                  ...
                  <h4 className="font-serif font-bold text-emerald-800 text-sm">
                    Review Submitted Successfully!
                  </h4>
                  <p className="text-[11px] text-emerald-600 font-medium">
                    Thank you for sharing your experience. Your feedback is now
                    live!
                  </p>
                </motion.div>
              ) : (
                <form onSubmit={handleReviewSubmit} className="space-y-4">
                  {/* Name field */}
                  <div>
                    <label className="block text-[9px] text-dark/50 font-bold uppercase tracking-wider mb-1">
                      Your Name
                    </label>
                    <input
                      type="text"
                  ...
                  {/* Rating Field */}
                  <div>
                    <label className="block text-[9px] text-dark/50 font-bold uppercase tracking-wider mb-2">
                      Your Rating
                    </label>
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
        ...
        {showRingSizeChart && (
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-6">
                  <h4 className="font-semibold text-dark text-base mb-3">
                  ...
                  <table className="w-full text-left border-collapse bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                    <thead>
                      <tr className="bg-gold-50 border-b border-gold-100">
                        <th className="px-4 py-3 text-xs font-bold text-dark/70 uppercase tracking-wider">
                          Indian Size
                        </th>
                        <th className="px-4 py-3 text-xs font-bold text-dark/70 uppercase tracking-wider">
                          US Size
                    ...
                    <tbody>
                      {ringSizeChart.map((size, index) => (
                        ...
                        >
                          <td className="px-4 py-3 text-sm font-bold text-gold-600">
                            {size.indian}
                          </td>
                          ...
                          <td className="px-4 py-3 text-sm text-dark/70 font-medium">
                            {size.diameter}
                          </td>
                          <td className="px-4 py-3 text-sm text-dark/70 font-medium">
                            {size.circumference}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-amber-800">
                      ...
                      <ul className="space-y-1 text-amber-700">
                        <li>
                          • Ring sizes can vary by ±0.5 sizes depending on
                          finger width and knuckle size
                        </li>
                        <li>
                        ...
                        <li>
                          • For wide bands (&gt;6mm), consider going up 0.5-1
                          size
                        </li>
                        <li>
                        ...
                        <li>
                          • Click on any size above to select it for your order
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-dark/60">
                        Find your perfect fit for handcrafted leather footwear
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-dark/70">
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • Place a piece of paper on a flat floor against a
                          wall
                        </li>
                        <li>
                        ...
                        <li>
                          • Mark the longest part of your foot (tip of the big
                          toe) on the paper
                        </li>
                        <li>
                          • Measure that distance with a ruler in centimeters
                          (cm)
                        </li>
                      </ul>
                    </div>
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • Compare your measured length against the "Foot
                          Length (cm)" column
                        </li>
                        <li>
                          • If your length is in between sizes, we recommend
                          selecting the larger size
                        </li>
                        <li>
                  ...
                  <table className="w-full text-left border-collapse bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                    ...
                    <tbody>
                      {chappalSizeChart.map((size, index) => (
                        ...
                        >
                          <td className="px-4 py-3 text-sm text-gold-600 font-bold">
                            {size.our}
                          </td>
                          <td className="px-4 py-3 text-sm text-dark/70">
                            {size.indiaUk}
                ...
                <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-amber-800">
                      ...
                      <ul className="space-y-1 text-amber-700">
                        <li>
                          • Handcrafted leather footwear naturally takes the
                          shape of your foot within a few wearings
                        </li>
                        <li>
                          • To soften them faster, apply a light coat of castor
                          oil or coconut oil to the inner leather straps
                        </li>
                        <li>
                          • Avoid exposing leather chappals to direct water or
                          moisture
                        </li>
                        <li>
                          • Click on any row above to select that size for your
                          order
                        </li>
                      </ul>
                    </div>
