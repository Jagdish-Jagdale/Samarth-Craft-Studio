...
const BRACELET =
  "https://images.unsplash.com/photo-1573408301185-9519f94d71f5?w=600&q=80";
const SANDAL =
...
export default function HomePage() {
  ...
  const displayBestSellers =
    bestSellers.length > 0 ? bestSellers : productsList.slice(0, 4);

  const marqueePhrases = homepageSettings.marquee.text
    .split("★")
    .map((s) => s.trim())
    .filter(Boolean)
    .map((s) => `★ ${s}`);
  ...
  return (
    <div className="bg-cream min-h-screen pb-16 md:pb-0">
      ...
      <section
        ref={heroRef}
        className="relative h-screen overflow-hidden bg-black font-inter"
      >
              ...
              >
                <Link to={heroSlides[currentSlide].link}>
                  <motion.button
                    whileHover={{
                      scale: 1.03,
                      backgroundColor: "rgba(201,152,42,0.9)",
                    }}
                    whileTap={{ scale: 0.97 }}
        ...
        <div className="bg-dark py-3 overflow-hidden" ref={marqRef}>
          <div className="marquee-track">
            {[...marqueePhrases, ...marqueePhrases].map((phrase, i) => (
              <span
                key={i}
                className="text-xs tracking-[0.3em] text-gold-400 mx-8 whitespace-nowrap font-medium"
              >
                {phrase}
              </span>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-center">
            ...
            <div className="lg:col-span-1 border-b lg:border-b-0 lg:border-r border-dark/5 pb-4 lg:pb-0 lg:pr-6 text-center lg:text-left">
              <span className="text-[10px] text-gold-600 font-bold uppercase tracking-[0.2em] block mb-1">
                Samartha Atelier
              </span>
            ...
            <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-6 lg:pl-6">
              ...
              <div className="flex items-center gap-4 bg-[#faf8f5] p-4 rounded-xl border border-dark/5 hover:border-gold-500/30 transition-all duration-300">
                ...
                <div>
                  <h4 className="font-serif font-bold text-dark text-xs tracking-wider uppercase">
                    COD Available
                  </h4>
                  <p className="text-[10px] text-dark/50 mt-0.5 leading-normal">
                    Pay on delivery across pin codes
                  </p>
                </div>
              </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <AnimatedText>
              <p className="text-xs font-medium tracking-widest text-gold-600 mb-4">
                OUR PHILOSOPHY
              </p>
            </AnimatedText>
            <AnimatedText delay={0.1}>
            ...
            <div ref={statsRef} className="grid grid-cols-3 gap-8">
              {[
                {
                  num: homepageSettings.stats.artisans,
                  suffix: "+",
                  label: "Master Artisans",
                },
                {
                  num: homepageSettings.stats.products,
                  suffix: "+",
                  label: "Handcrafted Products",
                },
                {
                  num: homepageSettings.stats.customers,
                  suffix: "+",
                ...
                >
                  ...
                  <div className="text-xs text-dark/50 tracking-wide mt-1">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
          ...
          <div className="relative">
            ...
            >
              <p className="font-serif italic text-dark/70 text-lg">
                "Heritage in every single step."
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <AnimatedText>
              <div className="inline-block">
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <span className="text-xs tracking-[0.3em] text-gold-600 font-bold uppercase">
                    Customer Favorites
                  </span>
                  <div className="h-px w-12 bg-gold-500"></div>
                </div>
                ...
                <p className="text-dark/60 text-lg max-w-2xl mx-auto text-center">
                  Discover our most loved pieces, handpicked by customers who
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center z-10">
                  <motion.div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle, rgba(201,152,42,0.9) 0%, rgba(201,152,42,0.6) 100%)",
                    ...
                    animate={{
                      boxShadow: [
                        "0 0 0 0px rgba(201,152,42,0.4)",
                        "0 0 0 20px rgba(201,152,42,0)",
                        "0 0 0 0px rgba(201,152,42,0)",
                      ],
                    }}
                    transition={{
                      boxShadow: {
                ...
                >
                  {reviews.map((rev, idx) => (
                    <motion.div
                      ...
                      transition={{
                        duration: 0.6,
                        delay: (idx % cardsToShow) * 0.15,
                      }}
                      whileHover={{
                        y: -6,
                        boxShadow: "0 12px 30px rgba(26,18,8,0.06)",
                      }}
                    ...
                    >
                      <div>
                        <div className="absolute top-6 right-8 text-gold-500/10 font-serif text-8xl pointer-events-none select-none">
                          “
                        </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-serif font-bold text-dark text-sm flex items-center gap-2">
                            {rev.customerName}
                            {rev.verified && (
                              <span className="text-[10px] bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 px-1.5 py-0.5 rounded font-sans font-bold uppercase">
                                Verified
                              </span>
                            )}
                          </h4>
                          <p className="text-xs text-dark/40 font-semibold tracking-wide">
                            {rev.location}
                          </p>
                        </div>
                      </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/50 text-[11px] font-semibold tracking-wider">
            ...
            >
              <div className="text-center relative">
                ...
                <p className="text-[10px] text-dark/45 uppercase tracking-widest font-bold">
                  Featured in our Happy Customer gallery
                </p>
              </div>
